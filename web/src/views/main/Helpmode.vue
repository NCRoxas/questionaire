<template>
	<div>
		...
		<h1 class="text-center text-success mb-5 mt-5">{{ question_title }} - Lernmodus</h1>
				...
				<div class="card mb-2">
					<div class="card-body">
						<div class="card-title d-flex">
							<h5>{{ questions[state.step].title }}</h5>
							<button class="btn btn-warning ms-auto" @click="showAnswer(questions[state.step].Answers)">
		...
		<div v-if="state.finished">
			<div class="d-flex justify-content-center mt-5">
				<h4 class="text-center">
					Lernmodus beendet! <br />
					Du hast {{ state.result }} von {{ questions.length }} Fragen richtig beantwortet!
				</h4>
			</div>
